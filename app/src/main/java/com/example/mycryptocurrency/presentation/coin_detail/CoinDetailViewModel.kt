...
import com.example.mycryptocurrency.domain.use_cases.get_coin.GetCoinUseCase
import com.example.mycryptocurrency.domain.use_cases.get_coins.GetCoinsUseCase
...
class CoinDetailViewModel @Inject constructor(
    ...
    init {
        savedStateHandle.get<String>(Constants.PARAM_COIN_ID)?.let { coindId ->
            getCoin(coindId)
        }
    }
